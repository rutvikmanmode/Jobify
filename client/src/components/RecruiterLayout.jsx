...
const menuItems = [
  ...
  { key: "manageJobs", label: "Manage Jobs", to: "/recruiter/jobs" },
  { key: "profile", label: "Recruiter Profile", to: "/recruiter/profile" },
...
export default function RecruiterLayout({ title, subtitle, headerAction = null, children }) {
